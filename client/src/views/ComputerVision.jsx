        ...
        <section className="cv">
          <div className="row">
            <div className="cv-col">
              ...
              <p>The Computer Vision subsystem is designed to <span className="emphasis">identify and locate</span> weeds in <span className="emphasis">real-time</span> as a <span className="emphasis">drone flies</span> over a crop field. It uses a model trained on images of a crop field labeled with Waterhemp weeds, which was then run on a Jetson Nano microcontroller. The model, implemented with a live video feed from a Luxonis OAK-D camera, is able to <span className="emphasis">localize</span> the weed within the frame using X and Y coordinates. In conjunction with a GPS, a python script is used to <span className="emphasis">calculate the coordinates</span> of the weed by reading <span className="emphasis">real-time data</span> from the GPS through the serial port. The model was tested for precision, recall, and mean average precision (mAP), with the best performing model having an mAP of approximately 62%. The final model was tested on a set of images to verify its accuracy and was able to detect weeds with an mAP of around 48.8%.</p>
            </div>
          </div>
          <hr />
